...
public class EventController : Controller
{
    ...
    public IActionResult Create()
    {
        var _activities = _activityRepository.GetAll()
           .Select(a => new DropDownViewModel {Id = a.Id, Name = a.Name});
    ...
    public IActionResult Create(EventInputModel inputModel)
    {
        if (ModelState.IsValid)
        {
            var friend = _friendRepository
                .FindById(inputModel.IdOrganizer);
            var activity = _activityRepository
                .FindById(inputModel.IdActivity);
            var date = Date.FromDate(inputModel.Date);
            var place = Place.Create(inputModel.City, inputModel.Street,
                inputModel.Number, inputModel.Reference);
    ...
    public IActionResult Details(Guid id)
    {
        ...
        var eventData = new
        {
            ...
            organizer = theEvent.Organizer.Name,
            city = theEvent.Place.City,
